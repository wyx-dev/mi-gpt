...
export default {
  ...
  speaker: {
    ...
    // 小米 ID
    userId: "1333648138", // 注意：不是手机号或邮箱，请在「个人信息」-「小米 ID」查看
    // 账号密码
    password: "sxm521...",
    // 小爱音箱 DID 或在米家中设置的名称
    did: "小米小爱音箱Play 增强版", // 注意空格、大小写和错别字（音响 👉 音箱）
    ...
    callAIKeywords: ["请", "你", "小梅"],
    // 当消息以下面的关键词开头时，会进入 AI 唤醒状态
    wakeUpKeywords: ["打开", "进入", "召唤"],
    // 当消息以下面的关键词开头时，会退出 AI 唤醒状态
    exitKeywords: ["关闭", "退出", "再见"],
    // 进入 AI 模式的欢迎语
    onEnterAI: ["你好，我是小梅，很高兴认识你"], // 设为空数组时可关闭提示语
    // 退出 AI 模式的提示语
    ...
    // 是否启用连续对话功能，部分小爱音箱型号无法查询到正确的播放状态，需要关闭连续对话,plat增强版不支持
